...
<br>
<br>
The Python code in this module is what interacts with the RCWL-0516 and turns the display on and off. It will try to auto detect if you are using X11 (Bullseye) or wayland (Bookworm / Trixie) and then try to detect the display output.<br><br>
The correct command to turn the display on and off should then be used.<br><br>
...
<br>
To reduce the detection range connected a [500k Trimmer pot](https://uk.rs-online.com/web/p/trimmer-potentiometers/1001234) to the range adjustment jumper.
